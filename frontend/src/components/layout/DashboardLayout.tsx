...
const navigation = [
  ...
  { name: "My Courses", href: "/courses/my-courses", icon: BookOpen },
  { name: "Browse Courses", href: "/courses", icon: Search },
  { name: "Certificates", href: "/certificates", icon: Award },
  { name: "Saved Courses", href: "/courses/saved", icon: Bookmark },
  { name: "Learning History", href: "/history", icon: History },
